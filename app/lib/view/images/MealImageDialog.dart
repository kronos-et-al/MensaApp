        ...
        if (snapshot.hasData) {
          switch (snapshot.requireData) {
            case Success<Meal, NoMealException> value:
              ...
              if (!isClosing && (meal.images == null || meal.images!.isEmpty)) {
                isClosing = true;
                SchedulerBinding.instance.addPostFrameCallback((_) {
                  Navigator.of(context).pop();
                });
              }
              ImageData? currentImage = currentPage >= 0
                      ...
                      return Center(
                        child: MensaButton(
                          ...
                          text: FlutterI18n.translate(
                            context,
                            "image.newImageButton",
                          ),
                        ),
                      );
                    }
                    return MealImageView(
                      imageData: meal.images![index],
                ...
                actions:
                    ...
                    : Padding(
                        ...
                        child: Row(
                          children: [
                            Text(
                              meal.images![currentPage].positiveRating
                                  .toString(),
                            ),
                            MensaIconButton(
                              semanticLabel: FlutterI18n.translate(
                            ...
                            MensaIconButton(
                              ...
                              icon: currentImage?.individualRating == -1
                                  ...
                                  : const MensaIcon(
                                      MensaIcons.thumbDownOutlined,
                                    ),
                            ),
                            Text(
                              meal.images![currentPage].negativeRating
                                  .toString(),
                            ),
                            const Spacer(),
                            MensaIconButton(
