...
class MealEnvironmentInfo extends StatelessWidget {
  ...
  const MealEnvironmentInfo({super.key, required EnvironmentInfo environmentInfo})
...
enum MealEnvironmentInfoType { co2, water, animalWelfare, rainforest }
...
class _MealEnvironmentInfoItem extends StatelessWidget {
  ...
  const _MealEnvironmentInfoItem(
            ...
            child: Ink(
              decoration: BoxDecoration(
                  color: _even
                      ...
                      : null),
              child: Padding(
                padding: EdgeInsets.only(left: _indent ? 16 : 0),
                child: Row(
                  children: [
                    Text(_name),
                    Spacer(),
