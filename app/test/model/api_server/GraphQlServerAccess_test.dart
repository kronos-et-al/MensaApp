...
void main() async {
  ...
  test('remove downvote', () async {
    var deleted = await serverAccess.deleteDownvote(
      ImageData(
  ...
  test('remove upvote', () async {
    var deleted = await serverAccess.deleteUpvote(
      ImageData(
        id: "bd3c88f9-5dc8-4773-85dc-53305930e7b6",
        url: "url",
        imageRank: 0,
  ...
  test('add downvote', () async {
    var deleted = await serverAccess.downvoteImage(
      ImageData(
        id: "bd3c88f9-5dc8-4773-85dc-53305930e7b6",
        url: "url",
        imageRank: 0,
  ...
  test('add upvote', () async {
    var deleted = await serverAccess.upvoteImage(
      ImageData(
        id: "bd3c88f9-5dc8-4773-85dc-53305930e7b6",
        url: "url",
        imageRank: 0,
  ...
  test('meal from id', () async {
    ...
    var _ = switch (result) {
      Success(value: final _) => true,
      Failure(exception: final exception) => expect(
        exception,
        true,
        reason: "exception while request",
      ),
    };
  });
