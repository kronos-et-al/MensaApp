...
| `IMAGE_ACCEPTANCE_VALUES`                | These values determine which images will be accepted and which not. More info about levels and categories are in the documentation.                                                                                                                                                           | `1,1,1,1,1`                                                                                                                  |
